...
const zh: Record<string, string> = {
  ...
  "general.workspace": "默认工作区",
  "general.workspace.desc": "智能体读写文件、生成物与附件的根目录（未选择项目时的会话使用）",
  "general.workspace.change": "更改…",
  "general.workspace.custom": "已自定义",
  "general.workspace.default": "默认位置",
  "general.workspace.save": "保存",
...
const en: Record<string, string> = {
  ...
  "general.workspace": "Default workspace",
  "general.workspace.desc": "Root directory for agent file operations, generated files, and attachments (sessions without a project)",
  "general.workspace.change": "Change…",
  "general.workspace.custom": "Custom",
  "general.workspace.default": "Default",
  "general.workspace.save": "Save",
